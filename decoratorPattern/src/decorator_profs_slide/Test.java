 ...
 * Si vuole fornire la possibilità di aggiungere gli ingredienti AbstractIngredient (maggiorazione di 1 Euro) e Salsiccia 
 ...
 * Si realizzino quindi le classi AbstractIngredient, Salsiccia e GlutFree come decoratori di Pizza, e quindi da usare in modo che il 
...
public class Test {
	...
	public void test(){
		...
		assertEquals(p1.getIngredients(),"Pomodoro, Mozzarella, Salsiccia, AbstractIngredient");
